...
function selectTile() {
    var itemsArray = [
        {
            picture: "/img/birdvswindow.jpg",
            score: -300
        }, {
            picture: "/img/miniCar.jpg",
            score: 300
        }, {
            picture: "/img/carWashpoop.jpg",
            score: 200
        }, {
            picture: "/img/porchsePoop.jpg",
            score: 400
        }, {
            picture: "/img/birdvswindow.jpg",
            score: -300
        }, {
            picture: "/img/bird17.jpg",
            score: 100
        }, {
            picture: "/img/bird9.jpg",
            score: 300
        }, {
            picture: "/img/car-poop.jpg",
            score: 200
        }, {
            picture: "/img/statuepoop.jpg",
            score: 300
        }, {
            picture: "/img/stuckFence.jpg",
            score: -400
        }, {
            picture: "/img/bird15.jpg",
            score: -100
        }, {
            picture: src="https://media.giphy.com/media/L15Zkr54ZxUxq/giphy.gif",
            score: -1000
        }, {
            picture: "/img/presidentPoop.jpg",
            score: 1000
        }, {
            picture: "/img/brd4.jpg",
            score: 500
        }, {
            picture: src="https://media.giphy.com/media/3o7TKWCunaX8HoXYdy/giphy.gif",
            score: 800
        }];
...
function resetBoard() {
    ...
    for (var row = 0; row < 4; row++) {
        ...
        for (var col = 0; col < 4; col++) {
            ...
            cardsHTML = cardsHTML + '<img class="one cover" src="/img/bird.png" />';
